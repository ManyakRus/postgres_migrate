...
func Find_MassAttribute_Delete(Settings *config.SettingsINI, VersionID int64) ([]SequenceAlter, error) {
...
func TextSQL_Delete(Settings *config.SettingsINI, MassClass []SequenceAlter) (string, error) {
	Otvet := ""
	var err error
