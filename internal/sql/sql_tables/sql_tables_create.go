...
func Start_Tables_create(Settings *config.SettingsINI, VersionID int64) (string, error) {
	...
	//найдём массив новых
	MassClass, err := Find_MassClass_Create(Settings, VersionID)
	if err != nil {
...
// Find_MassClass_Create - возвращает массив postgres_migrate_pg_class
func Find_MassClass_Create(Settings *config.SettingsINI, VersionID int64) ([]postgres_migrate_pg_class.PostgresMigratePgClass, error) {
