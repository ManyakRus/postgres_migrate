...
// PgIndex_ReadFromCache - читает и возвращает модель из кеша или БД
func (s *ServerGRPC) PgIndex_ReadFromCache(ctx context.Context, Request *grpc_proto.Request_Int64_Int64_Int64) (*grpc_proto.Response, error) {
	...
	Model := pg_index.PgIndex{}
	Model, err = crud_pg_index.ReadFromCache_ctx(ctx, db, Indexrelid, Indrelid, VersionID)
	if err != nil {
		return &Otvet, err
	}
