...
func (crud Crud_GRPC) ReadFromCache(Seqrelid int64, VersionID int64) (postgres_migrate_pg_sequence.PostgresMigratePgSequence, error) {
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PostgresMigratePgSequence_ReadFromCache(Request)
	} else {
		Response, err = grpc_client_func.Client.PostgresMigratePgSequence_ReadFromCache(ctx, Request)
	}
	if err != nil {
