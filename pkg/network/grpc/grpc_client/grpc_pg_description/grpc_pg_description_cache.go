...
func (crud Crud_GRPC) ReadFromCache(Classoid int64, Objoid int64, Objsubid int32, VersionID int64) (pg_description.PgDescription, error) {
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PgDescription_ReadFromCache(Request)
	} else {
		Response, err = grpc_client_func.Client.PgDescription_ReadFromCache(ctx, Request)
	}
	if err != nil {
