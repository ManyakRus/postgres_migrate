...
func (crud Crud_GRPC) ReadObject(m *object_pg_index.ObjectPgIndex) error {
	var err error
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PgIndex_ReadObject(Request)
	} else {
		Response, err = grpc_client_func.Client.PgIndex_ReadObject(ctx, Request)
	}
	if err != nil {
