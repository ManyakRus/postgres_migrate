...
func (crud Crud_GRPC) ReadObject(m *object_version.ObjectVersion) error {
	var err error
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.Version_ReadObject(Request)
	} else {
		Response, err = grpc_client_func.Client.Version_ReadObject(ctx, Request)
	}
	if err != nil {
