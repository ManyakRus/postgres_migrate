...
func (crud Crud_GRPC) ReadObject(m *object_pg_class.ObjectPgClass) error {
	var err error
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PgClass_ReadObject(Request)
	} else {
		Response, err = grpc_client_func.Client.PgClass_ReadObject(ctx, Request)
	}
	if err != nil {
