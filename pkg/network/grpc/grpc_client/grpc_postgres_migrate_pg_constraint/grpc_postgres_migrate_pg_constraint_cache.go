...
func (crud Crud_GRPC) ReadFromCache(Oid int64, VersionID int64) (postgres_migrate_pg_constraint.PostgresMigratePgConstraint, error) {
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PostgresMigratePgConstraint_ReadFromCache(Request)
	} else {
		Response, err = grpc_client_func.Client.PostgresMigratePgConstraint_ReadFromCache(ctx, Request)
	}
	if err != nil {
