...
func (crud Crud_GRPC) ReadObject(m *object_pg_namespace.ObjectPgNamespace) error {
	var err error
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PgNamespace_ReadObject(Request)
	} else {
		Response, err = grpc_client_func.Client.PgNamespace_ReadObject(ctx, Request)
	}
	if err != nil {
