...
func (crud Crud_GRPC) ReadObject(m *object_pg_constraint.ObjectPgConstraint) error {
	var err error
	...
	if grpc_nrpc.NeedNRPC == true {
		//Response, err = nrpc_client.Client.PgConstraint_ReadObject(Request)
	} else {
		Response, err = grpc_client_func.Client.PgConstraint_ReadObject(ctx, Request)
	}
	if err != nil {
