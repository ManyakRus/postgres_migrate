...
func TestReadFromCache(t *testing.T) {
	...
	//читаем из БД
	m1 := postgres_migrate_pg_attribute.PostgresMigratePgAttribute{}
	m1.Attname = ATTNAME_Test
	m1.Attrelid = ATTRELID_Test
	...
	//читаем из Кеша
	m2, err := Crud_DB{}.ReadFromCache(ATTNAME_Test, ATTRELID_Test, VERSIONID_Test)
	if err != nil {
