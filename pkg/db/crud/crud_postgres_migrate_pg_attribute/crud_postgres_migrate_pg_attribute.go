...
const TableName string = "postgres_migrate_pg_attribute"
...
func (crud Crud_DB) Read(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
...
func Read_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
...
func (crud Crud_DB) Save(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(db_constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func Save_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Update(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(db_constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func Update_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) Create(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	ctxMain := contextmain.GetContext()
	ctx, ctxCancelFunc := context.WithTimeout(ctxMain, time.Second*time.Duration(db_constants.TIMEOUT_DB_SECONDS))
	defer ctxCancelFunc()
...
func Create_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
	if micro.ContextDone(ctx) == true {
		err = context.Canceled
		return err
...
func (crud Crud_DB) create_update(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
...
func create_update_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Delete(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
...
func Delete_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
	...
	m2 := postgres_migrate_pg_attribute.PostgresMigratePgAttribute{}
	m2.Attname = m.Attname
	m2.Attrelid = m.Attrelid
	...
	if err != nil {
		err = fmt.Errorf(m.TableNameDB()+" Delete() Attname: %v, error: %w", m.Attname, err)
	}
...
func (crud Crud_DB) Restore(m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
...
func Restore_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_attribute.PostgresMigratePgAttribute) error {
	var err error
	...
	err = Save_ctx(ctx, db, &m2)
	if err != nil {
		err = fmt.Errorf(m.TableNameDB()+" Restore() Attname: %v, error: %w", m.Attname, err)
	}
