...
func (crud Crud_DB) UpdateManyFields(m *pg_description.PgDescription, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *pg_description.PgDescription, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Classoid(m *pg_description.PgDescription) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Classoid_ctx(ctx context.Context, db *gorm.DB, m *pg_description.PgDescription) error {
	var err error
...
func (crud Crud_DB) Update_Description(m *pg_description.PgDescription) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Description_ctx(ctx context.Context, db *gorm.DB, m *pg_description.PgDescription) error {
	var err error
...
func (crud Crud_DB) Update_Objoid(m *pg_description.PgDescription) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Objoid_ctx(ctx context.Context, db *gorm.DB, m *pg_description.PgDescription) error {
	var err error
...
func (crud Crud_DB) Update_Objsubid(m *pg_description.PgDescription) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Objsubid_ctx(ctx context.Context, db *gorm.DB, m *pg_description.PgDescription) error {
	var err error
...
func (crud Crud_DB) Update_VersionID(m *pg_description.PgDescription) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_VersionID_ctx(ctx context.Context, db *gorm.DB, m *pg_description.PgDescription) error {
	var err error
