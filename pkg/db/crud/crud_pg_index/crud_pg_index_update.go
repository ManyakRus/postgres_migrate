...
func (crud Crud_DB) UpdateManyFields(m *pg_index.PgIndex, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Indcheckxmin(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indcheckxmin_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
	...
	//удалим из кэша
	cache.Remove(pg_index.StringIdentifier(m.Indexrelid, m.Indrelid, m.VersionID))

	return err
}

// Update_Indclass - изменяет 1 поле Indclass в базе данных
func (crud Crud_DB) Update_Indclass(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indclass_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indcollation(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indcollation_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indexprs(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indexprs_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indexrelid(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indexrelid_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indimmediate(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indimmediate_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisclustered(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisclustered_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisexclusion(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisexclusion_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indislive(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indislive_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisprimary(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisprimary_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisready(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisready_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisreplident(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisreplident_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisunique(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisunique_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indisvalid(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indisvalid_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indkey(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indkey_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indnatts(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indnatts_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indnkeyatts(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indnkeyatts_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indoption(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indoption_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indpred(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indpred_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_Indrelid(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Indrelid_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
...
func (crud Crud_DB) Update_VersionID(m *pg_index.PgIndex) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_VersionID_ctx(ctx context.Context, db *gorm.DB, m *pg_index.PgIndex) error {
	var err error
