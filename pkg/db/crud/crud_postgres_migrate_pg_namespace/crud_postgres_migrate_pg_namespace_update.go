...
func (crud Crud_DB) UpdateManyFields(m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Nspacl(m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Nspacl_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
func (crud Crud_DB) Update_Nspname(m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Nspname_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
func (crud Crud_DB) Update_Nspowner(m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Nspowner_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
func (crud Crud_DB) Update_Oid(m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Oid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
func (crud Crud_DB) Update_VersionID(m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_VersionID_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_namespace.PostgresMigratePgNamespace) error {
	var err error
