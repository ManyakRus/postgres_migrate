...
func (crud Crud_DB) UpdateManyFields(m *pg_class.PgClass, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Oid(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Oid_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
	...
	//удалим из кэша
	cache.Remove(pg_class.StringIdentifier(m.Oid, m.VersionID))

	return err
}

// Update_Relallvisible - изменяет 1 поле Relallvisible в базе данных
func (crud Crud_DB) Update_Relallvisible(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relallvisible_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relam(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relam_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relchecks(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relchecks_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relfilenode(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relfilenode_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relforcerowsecurity(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relforcerowsecurity_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relfrozenxid(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relfrozenxid_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relhasindex(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relhasindex_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relhasrules(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relhasrules_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relhassubclass(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relhassubclass_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relhastriggers(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relhastriggers_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relispartition(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relispartition_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relispopulated(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relispopulated_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relisshared(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relisshared_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relkind(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relkind_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relminmxid(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relminmxid_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relname(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relname_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relnamespace(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relnamespace_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relnatts(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relnatts_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Reloftype(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Reloftype_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relowner(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relowner_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relpages(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relpages_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relpersistence(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relpersistence_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relreplident(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relreplident_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relrewrite(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relrewrite_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Relrowsecurity(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Relrowsecurity_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Reltablespace(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Reltablespace_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Reltoastrelid(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Reltoastrelid_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Reltuples(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Reltuples_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_Reltype(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Reltype_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
...
func (crud Crud_DB) Update_VersionID(m *pg_class.PgClass) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_VersionID_ctx(ctx context.Context, db *gorm.DB, m *pg_class.PgClass) error {
	var err error
