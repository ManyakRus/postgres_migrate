...
func (crud Crud_DB) UpdateManyFields(m *version.Version, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *version.Version, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Description(m *version.Version) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Description_ctx(ctx context.Context, db *gorm.DB, m *version.Version) error {
	var err error
...
func (crud Crud_DB) Update_Name(m *version.Version) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Name_ctx(ctx context.Context, db *gorm.DB, m *version.Version) error {
	var err error
