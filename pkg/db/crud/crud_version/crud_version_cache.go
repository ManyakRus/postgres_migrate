...
// cache - кэш с данными
var cache *expirable.LRU[int64, version.Version]
...
func init() {
	cache = expirable.NewLRU[int64, version.Version](CACHE_SIZE, nil, time.Minute*CACHE_EXPIRE_MINUTES)
}

// ReadFromCache - находит запись в кеше или в БД по ID
func (crud Crud_DB) ReadFromCache(ID int64) (version.Version, error) {
	var Otvet version.Version
	var err error
...
func ReadFromCache_ctx(ctx context.Context, db *gorm.DB, ID int64) (version.Version, error) {
	var Otvet version.Version
	var err error
