...
func TestReadFromCache(t *testing.T) {
	...
	//читаем из БД
	m1 := postgres_migrate_pg_description.PostgresMigratePgDescription{}
	m1.Classoid = CLASSOID_Test
	m1.Objoid = OBJOID_Test
	m1.Objsubid = OBJSUBID_Test
	...
	//читаем из Кеша
	m2, err := Crud_DB{}.ReadFromCache(CLASSOID_Test, OBJOID_Test, OBJSUBID_Test, VERSIONID_Test)
	if err != nil {
