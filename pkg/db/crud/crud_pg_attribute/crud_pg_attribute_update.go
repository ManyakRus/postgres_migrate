...
func (crud Crud_DB) UpdateManyFields(m *pg_attribute.PgAttribute, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Attalign(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attalign_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attbyval(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attbyval_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attcacheoff(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attcacheoff_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attcollation(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attcollation_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attgenerated(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attgenerated_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Atthasdef(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Atthasdef_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Atthasmissing(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Atthasmissing_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attidentity(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attidentity_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attinhcount(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attinhcount_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attisdropped(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attisdropped_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attislocal(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attislocal_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attlen(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attlen_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attname(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attname_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attndims(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attndims_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attnotnull(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attnotnull_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attnum(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attnum_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attrelid(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attrelid_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attstattarget(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attstattarget_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Attstorage(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Attstorage_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Atttypid(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Atttypid_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_Atttypmod(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Atttypmod_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
...
func (crud Crud_DB) Update_VersionID(m *pg_attribute.PgAttribute) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_VersionID_ctx(ctx context.Context, db *gorm.DB, m *pg_attribute.PgAttribute) error {
	var err error
