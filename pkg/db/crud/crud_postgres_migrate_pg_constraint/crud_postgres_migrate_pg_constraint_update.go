...
func (crud Crud_DB) UpdateManyFields(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint, MassNeedUpdateFields []string) error {
	var err error
...
// MassNeedUpdateFields - список полей структуры golang для обновления
func UpdateManyFields_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint, MassNeedUpdateFields []string) error {
	var err error
...
func (crud Crud_DB) Update_Condeferrable(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Condeferrable_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
	...
	//удалим из кэша
	cache.Remove(postgres_migrate_pg_constraint.StringIdentifier(m.Oid, m.VersionID))

	return err
}

// Update_Condeferred - изменяет 1 поле Condeferred в базе данных
func (crud Crud_DB) Update_Condeferred(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Condeferred_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conexclop(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conexclop_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Confdeltype(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Confdeltype_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conffeqop(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conffeqop_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Confkey(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Confkey_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Confmatchtype(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Confmatchtype_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Confrelid(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Confrelid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Confupdtype(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Confupdtype_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conindid(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conindid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Coninhcount(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Coninhcount_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conislocal(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conislocal_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conkey(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conkey_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conname(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conname_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Connamespace(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Connamespace_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Connoinherit(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Connoinherit_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conparentid(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conparentid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conpfeqop(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conpfeqop_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conppeqop(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conppeqop_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Conrelid(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Conrelid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Contype(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Contype_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Contypid(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Contypid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Convalidated(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Convalidated_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_Oid(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_Oid_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
func (crud Crud_DB) Update_VersionID(m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
...
// с учётом контекста и соединения к БД
func Update_VersionID_ctx(ctx context.Context, db *gorm.DB, m *postgres_migrate_pg_constraint.PostgresMigratePgConstraint) error {
	var err error
