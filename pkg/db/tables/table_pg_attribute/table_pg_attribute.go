package table_pg_attribute


// Table_PgAttribute - модель для таблицы pg_attribute: В каталоге pg_attribute хранится информация о столбцах таблицы. Для каждого столбца каждой таблицы в pg_attribute существует ровно одна строка.
type Table_PgAttribute struct {
